...
OUTPUT_HDFS="/output/director_movie_count"
...
hadoop jar $HADOOP_STREAMING_JAR \
    -input $INPUT_HDFS \
    -output $OUTPUT_HDFS \
    -mapper "python3 director_movie_count.py mapper" \
    -reducer "python3 director_movie_count.py reducer" \
    -file director_movie_count.py
