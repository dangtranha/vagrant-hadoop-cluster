...
OUTPUT_HDFS="/output/director_total_revenue"
...
hadoop jar $HADOOP_STREAMING_JAR \
    -input $INPUT_HDFS \
    -output $OUTPUT_HDFS \
    -mapper "python3 director_total_revenue.py mapper" \
    -reducer "python3 director_total_revenue.py reducer" \
    -file director_total_revenue.py
